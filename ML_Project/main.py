...
from plyer import accelerometer, gravity, vibrator

import Client

#from plyer import gamerotation
...
class ConnectPage(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.username = TextInput(
            text=prev_username, multiline=False, font_size=40)
    ...
    def join_button(self, instance):
        ...
        if port.isalnum():
            ...
            popup = Popup(title="Error No Input !", content=content,
...
class ChatPage(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.add_widget(
            Label(text="Press STOP to stop sending accelerometer data", font_size=30))

        self.stop = Button(text="STOP", font_size=60,
                           size_hint_y=None, height=100)
        self.stop.bind(on_press=self.stop_client)
        self.add_widget(self.stop)

        self.back = Button(text="Back", font_size=60,
                           size_hint_y=None, height=100)
    ...
    def update(self, dt):
        ...
        message = self.AcceX+self.AcceY+self.AcceZ+self.graX+self.graY+self.graZ
        Client.send(message)
